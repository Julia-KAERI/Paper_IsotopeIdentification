...
$$ {#eq-Lee2020_1}
논문 Eq.(1) (@eq-Lee2020_1} 에 따라 각 채널의 count $C_i$ 에 해당 채널의 에너지 $E_i$ 를 곱해  
$C_{EW,i}$ 로 변환한다.

![본문 Fig. 1 Trends in energy weighted spectra after applying the linear energy coefficient to the energy spectra with: (A) a constant count and (B) a gamma source measured with PVT.](figures/Lee2020Raidioisotope_fig_01.png){width=600}

이 기법은(페이지 2–3, Fig. 1):  


![본문 Fig. 2.](figures/Lee2020Radioisotope_fig_02.png){width=600}
...
![본문 Fig. 6.](figures/Lee2020Radioisotope_fig_06.png){width=600}
