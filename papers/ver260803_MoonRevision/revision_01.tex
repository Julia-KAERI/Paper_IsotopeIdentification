...
\begin{table}[h]
\centering
\caption{BCCS-NNLS fitting results for single source. Rows for reference spectra are shaded. $d$ is the distance to the detector. $d_0/d$ is the inverse ratio of distance to the reference spectrum. $\Omega/\Omega_0$ is the ratio of the solid angle to the reference isotope. Count sum ratio is the ratio of the sum of livetime normalized spectrum to the reference isotope. $\alpha_\text{Am}$, $\alpha_\text{Co}$, $\alpha_\text{Cs}$ are the contributions calculated from the NNLS.}
...
\rowcolor{gray!20} Co-60   & 60    &      1.000 &     1.000 &        1.000 &-0.000(   inf) &  1.000(   inf) &  0.000(   inf) \\
...
\rowcolor{gray!20} Cs-137  & 70    &      1.000 &     1.000 &        1.000 & 0.000(   inf) &  0.000(   inf) &  1.000(   inf) \\
...
%  Cs-137 + Co-60 & 136 / 136 & 19.134 & Mixed-source dataset \\
%  Am-241 + Co-60 & 287 / 287 & 19.676 & Mixed-source dataset \\
%  Cs-137 + Co-60 & 361 / 361 & 19.716 & Mixed-source dataset \\
%  Am-241 + Cs-137 & 163 / 163 & 19.628 & Mixed-source dataset \\
%  Am-241 + Cs-137 + Co-60 & 309 / 309 / 309 & 19.574 & e dataset \\
%  Co-60 + Am-241 & 153 / 210 & 19.310 & Separated source positions \\
%  Cs-137 + Co-60 & 367 / 285 & 19.568 & Separated source positions \\
%  Am-241 + Cs-137 & 85 / 173 & 19.554 &  Separated source positions \\
%  Cs-137 + Co-60 & 223 / 316 & 19.470 & Separated source positions\\
% 
...
% |           cs |            70 |    1.00000000 |  0.000 +/-    inf |  0.000 +/-    inf |  1.000 +/-    inf |
% |           cs |           130 |    0.28994083 |  0.067 +/-  0.006 |  0.005 +/-  0.002 |  0.384 +/-  0.002 |
% |           cs |           300 |    0.05444444 |  0.040 +/-  0.006 |  0.006 +/-  0.002 |  0.085 +/-  0.002 |
% |           cs |           390 |    0.03221565 |  0.049 +/-  0.006 |  0.000 +/-  0.002 |  0.052 +/-  0.002 |
\botrule
\end{tabular}
\end{table}
